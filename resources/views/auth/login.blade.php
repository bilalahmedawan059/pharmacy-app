	...
	<div class="auth-content text-center">
		...
		<div class="card borderless">
			<div class="row align-items-center ">
				<div class="col-md-12">
					<div class="card-body">
                        <img src="{{ asset('img/CDL Logo.png') }}" width="200" style="width: 65px" alt="" class="img-fluid mb-4">
						...
						<div class="form-group mb-3">
							...
							@error('email')
								<span class="invalid-feedback" role="alert" style="text-align: left !important">
