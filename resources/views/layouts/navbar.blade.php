            ...
            <ul class="nav pcoded-inner-navbar sidenav-inner">
                    ...
                    <li class="nav-item pcoded-hasmenu {{ route_is(('products')) || route_is(('add-product')) || route_is(('outstock')) || route_is(('expired')) || route_is(('edit-product')) ? 'active active-cover' : '' }}">
                        ...
                        <ul class="pcoded-submenu">
                            @can('view-products')<li class="{{ route_is(('products')) ? 'active active-cover' : '' }}"><a  href="{{route('products')}}">Medicines</a></li>@endcan
                            @can('create-product')<li class="{{ route_is('add-product') ? 'active active-cover' : '' }}"><a  href="{{route('add-product')}}">Add Medicine</a></li>@endcan
                            @can('view-outstock-products')<li class="{{ route_is('outstock') ? 'active active-cover' : '' }}"><a  href="{{route('outstock')}}">Out-Stock</a></li>@endcan
                            @can('view-expired-products')<li class="{{ route_is('expired') ? 'active active-cover' : '' }}"><a  href="{{route('expired')}}">Expired</a></li>@endcan
                        </ul>
                    </li>
                    @endcan
