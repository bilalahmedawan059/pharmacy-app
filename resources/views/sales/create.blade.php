...
{{--        </div>--}}
        <div class="col-12">
            <div class="form-group">
                ...
                <select class="select2 form-select form-control edit_product" name="product" id="product-dropdown">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="number" value="1" class="form-control edit_quantity" name="quantity" id="quantity">
            </div>
        </div>
    </div>
